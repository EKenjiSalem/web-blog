...
function BlogCard() {
  ...
  return (
    <section className="blog-card" id="blog">
      <div className="blog-card-container">

          <div className="blog-card-info" data-aos="zoom-in">
            <img src={sidebar} alt="" />
            <div className="blog-card-content">
              {/* <span className="blog-date"> April 25th, 2022 </span> */}
               <Link to="/MasterWeb"> <h3 className='blog-card-title'> Mastering Web Development </h3> </Link> 
          ...
          <div className="blog-card-info" data-aos="zoom-in">
            ...
            <div className="blog-card-content">
            {/* <span className="blog-date"> April 25th, 2022 </span> */}
              <Link to="/Certificate"><h3 className='blog-card-title'> Meta Front-End Web Development Certificate </h3></Link>
              <p className="blog-card-description"> 
          ...
          <div className="react-blog-card-info" data-aos="zoom-in">
            <img src={reactpost} className="react-img" alt="" />
            <div className="react-blog-card-content">
            {/* <span className="blog-date"> April 25th, 2022 </span> */}
              <Link to="/ApiReact"><h3 className='react-blog-card-title'> React Api's </h3></Link>
              <p className="blog-card-description"> 
          ...
          <div className="blog-card-dom-info" data-aos="zoom-in">
            <img src={sidebar} alt="" />
            <div className="blog-card-content">
            {/* <span className="blog-date"> April 25th, 2022 </span> */}
              <Link to="/DomLearn"><h3 className='blog-card-title'> Why is the DOM taught Last? </h3></Link>
              <p className="blog-card-description"> 
          ...
          <div className="css-blog-card-info" data-aos="zoom-in">
            <img src={csspost} alt="" />
            <div className="css-blog-card-content">
              <Link to="/Animations"><h3 className='css-blog-card-title'> Amazing Animations </h3></Link>
              <p className="blog-card-description"> 
              ...
              their fundamentals, usage, and best practices. </p>
              <Link to="/Animations"><button className="button"> Read More </button></Link>
             </div>
           </div>


          <div className="js-blog-card-info" data-aos="zoom-in">
            <img src={jspost}  alt="" />
            <div className="js-blog-card-content">
            {/* <span className="blog-date"> April 25th, 2022 </span> */}
              <Link to="/Functions"> <h3 className='js-blog-card-title'> Functions </h3></Link>
              <p className="blog-card-description"> 
              ...
              contribute to building dynamic and interactive web applications. </p>
