...
const Specificity = () => {
  return (
    <div className="css-post">
      ...
      <br />
      <br />
      Inline styles: are the most specific because they are directly applied to an individual element.
      They have the highest weight.
      <br />
      <br />
      ID selectors: have a higher weight than class selectors, making them more specific.
      <br />
      <br />
      Class selector:s are more specific than type selectors. They have a higher weight.
      <br />
      <br />
      Type selectors: These selectors are the least specific and have the lowest
      weight.
      <br />
      <br />
      !important: Adding !important to a CSS rule gives it the highest specificity and overrides 
