...
<br />
        ...
        <h1 className="attr-title">  Name and Value Attributes:</h1>
         <div className="name-attr-main"> These attributes are often used in forms
         ...
         <div className="input-btn-main"> The input element can also be used to create buttons. 
       ...
       <h1 className="onclick-title"> OnClick Attribute: </h1> 
        <div className="onclick-attr"> The onclick attribute allows you to 
         specify JavaScript code to execute when the button is clicked. </div>
        ...
        <div className="img-btn-main"> You can use an img element within a button
         element to create a button with an image. This is often done when you 
         want the image itself to serve as the clickable element. </div>
